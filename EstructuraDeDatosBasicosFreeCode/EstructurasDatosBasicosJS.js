...
//en el ejercicio de arriba, en la variable popped, almacenamos el elemento que eliminamos que en este caso es complete, porque se usa la propiedad .pop(), el último elemento de la cadena. Y ocurre lo mismmo con la variable shifted, almacena el primer cáracter del array con la propiedad .shif()
...
/*es importante entender este ejercicio, la función copyMachine te pide un array y un número de veces que lo quieres copiar, como resultado te retorna un nuevo array con el número de copias previamente introducidas. Se declara el nuevo array afuera del while, para poder retornarlo por afuera del bucle, se escribe la condición de que num debe ser mayor o igual a 1, y que se pusheará al nuevo array por iteración usando el spread operator el array que estamos pasando por parámetros hasta que se rompa el bucle.*/
...
/*Agregar elementos a un objeto dentro de otro objeto, siempre se debe pasar propiedad y valor de la propiedad, se debe usar la notación con corchetes para poder pasar una variable, se debe tratar de almacenar la notación en otra variable para que sea más legible como en este caso newProperty, cumple esa función */
